        ...
        <div class="container-fluid">
            <div class="header-row justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <a href="{{ $ref_sosmed->facebook }}" class="social-icon si-facebook si-secondary mr-2" target="_blank">
                        <i class="icon-facebook"></i>
                        <i class="icon-facebook"></i>
                    </a>
                    <a href="{{ $ref_sosmed->twitter }}" class="social-icon si-twitter si-secondary mr-2" target="_blank">
                        <i class="icon-twitter"></i>
                        <i class="icon-twitter"></i>
                    </a>
                    <a href="{{ $ref_sosmed->instagram }}" class="social-icon si-instagram si-secondary mr-2" target="_blank">

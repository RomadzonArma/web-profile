...
@section('contents')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header rounded-lg" style="background-color: #365984; color: white;">
                    @if (rbacCheck('manajemen_galeri', 2))
    ...
    <div id="modal-galeri" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-galeriLabel"
        aria-hidden="true">
        <form action="{{ route('manajemen_galeri.store') }}" method="post" id="form-galeri" enctype="multipart/form-data"
            autocomplete="off">
            @csrf
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0" id="modal-galeriLabel">Form Tambah panduan</h5>
    ...
    <form action="{{ route('manajemen_galeri.update') }}" method="post" id="form-update-galeri" autocomplete="off">
...
@push('scripts')
    ...
    <script src="{{ asset('js/page/galeri/list.js?q=' . Str::random(5)) }}"></script>
@endpush

...
@section('contents')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('list_berita.update', ['id' => encrypt($data->id)]) }}" method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="lead" id="lead" class="form-control"
                                placeholder="Masukkan lead" value="{{ $data->lead }}" required>
                            <div id="error-judul"></div>
                        </div>
                        <div class="form-group">
                        ...
                        <a href="{{ route('list_berita.index') }}" class="btn btn-secondary">
...
@push('scripts')
    <script src="{{ asset('js/page/ListBerita/update.js?q=' . Str::random(5)) }}"></script>
@endpush

            ...
            <div class="card-body">
                <form action="{{ route('list_berita.store') }}" method="post" name="form-store" id="form-store">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="lead" id="lead" class="form-control" placeholder="Masukkan lead" required>
                        <div id="error-judul"></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tag_dinamis" id="tag_dinamis" class="form-control" placeholder="Masukkan tag, contoh: kemendikbud, jakarta, salingberbagi" required>
                    ...
                    <div class="form-group mt-2" id="url_video_container" style="display: none;">
                        ...
                        <input type="text" name="url_video" id="url_video" class="form-control" placeholder="Masukkan url video" >
                        <div id="error-url_video"></div>
                    </div>

                    <div class="custom-control custom-checkbox custom-control-right">
                        <input type="checkbox" class="custom-control-input" id="status_headline" name="status_headline">
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="date" id="date" class="form-control" placeholder="Masukkan waktu tayang" required>
...
<script src="{{ asset('js/page/ListBerita/store.js?q=' . Str::random(5)) }}"></script>
@endpush

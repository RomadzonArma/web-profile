<div class="row">
    <div class="col-lg-12">
        ...
        <input style="display: none;" accept=".pdf" type="file" name="dokumen[]" multiple id="input-file-modal" data-id="{{ $data->encrypted_id }}" onchange="upload_dokumen_modal(this)">
    </div>

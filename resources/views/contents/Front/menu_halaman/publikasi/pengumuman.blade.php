...
@section('content')
    <div class="col-md-9 col-12">
        <form class="row mb-4" method="get" action="{{ url('/pengumumans') }}">
        ...
        <div class="result-pengumuman">
                ...
                <div class="entry mb-5">
                    <div class="grid-inner row no-gutters p-0">
                        ...
                        <div class="col-md-8 pl-md-4">
                            ...
                            <a class="more-link" href="/pengumumans/detail/{{ $item->id }}">Baca Lebih Lanjut</a>
                        </div>
                    </div>
                </div>
            @endforeach
            ...
            <ul class="pagination pagination-circle justify-content-center">
                ...
                @else
                    <li class="page-item"><a class="page-link" href="{{ $pengumuman->previousPageUrl() }}"
                            aria-label="Previous"><span aria-hidden="true">«</span></a></li>
                @endif

                @foreach (range(1, $pengumuman->lastPage()) as $page)
                ...
                @if ($pengumuman->hasMorePages())
                    <li class="page-item"><a class="page-link" href="{{ $pengumuman->nextPageUrl() }}" aria-label="Next"><span

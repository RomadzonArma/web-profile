...
@section('contents')
    ...
    <div id="modal-harlindung" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal-harlindungLabel"
        aria-hidden="true">
        <form method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('harlindung.store') }}"
            id="form-harlindung">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header bg-primary-bold">
                        <h4 class="modal-title mt-0" id="myModalLabel">Form Tambah Harlindung</h4>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nama_sub_program">Nama Harlindung</label>
                        ...
                        <div class="form-group row_foto" style="display: none;">
                            <label for="foto_harlindung">Foto harlindung</label>
                            <div class="custom-file mb-3">
                                <input type="file" class="custom-file-input" name="foto_harlindung" id="foto_harlindung"
                                    accept=".jpg,.jpeg,.png">
                            ...
                            <div id="foto_harlindung-preview" class="mt-3"></div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="form_foto">Thumbnail harlindung</label>
                            <div class="custom-file mb-3">
    ...
    <div id="modal-harlindung-update" class="modal fade" tabindex="-1" role="dialog"
        aria-labelledby="modal-harlindung-updateLabel" aria-hidden="true">
        <form action="{{ route('harlindung.update') }}" method="post" id="form-harlindung-update" autocomplete="off"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title mt-0" id="modal-harlindung-updateLabel">Form Edit harlindung</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="judul">Judul harlindung</label>
                        ...
                        <div class="form-group row_foto" style="display: none;">
                            <label for="foto-harlindungs">Foto harlindung</label>
                            <div class="custom-file mb-3">
                                <input type="file" class="custom-file-input" name="foto_harlindung"
                                    id="update-foto_harlindung" accept=".jpg,.jpeg,.png">
                                <label class="custom-file-label" for="UpdateFotoharlindung">Cari Gambar</label>
                            </div>
                            <small id="videoHelpBlock" class="form-text text-muted">
                                Hanya file video yang diizinkan (.jpg, .jpeg, .png) <b class="text-danger">Max 2.mb</b>
                            </small>
                        ...
                        <div class="form-group">
                            <label for="tumb">Thumbnail harlindung</label>
                            <div class="custom-file mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group row_foto">
                                        <label for="pdf_preview">Foto harlindung Preview</label>
                                        <div id="updateharlindungPreview" class="mt-3"></div>
                                    </div>
...
@push('scripts')
    <script>
        ...
        document.getElementById("foto_harlindung").addEventListener("change", function() {
            var file = this.files[0];
            var fileLabel = document.querySelector('label[for="foto_harlindung"]');
            fileLabel.innerHTML = file.name;

            var reader = new FileReader();
            reader.onload = function(e) {
                var imagePreview = document.getElementById("foto_harlindung-preview");
                imagePreview.innerHTML = '<img src="' + e.target.result +
                    '" class="img-fluid" style="height:200px;width:auto" alt="Selected Image">';
            };
            reader.readAsDataURL(file);
        ...
        document.getElementById("update-foto_harlindung").addEventListener("change", function() {
            var file = this.files[0];
            var fileLabel = document.querySelector('label[for="UpdateFotoharlindung"]');
            fileLabel.innerHTML = file.name;

            var reader = new FileReader();
            reader.onload = function(e) {
                var imagePreview = document.getElementById("updateharlindungPreview");
                imagePreview.innerHTML = '<img src="' + e.target.result +
                    '" class="img-fluid" style="height:200px;width:auto" alt="Selected Image">';
            };
            reader.readAsDataURL(file);
        ...
        $('#modal-harlindung').on('hidden.bs.modal', function() {
    ...
    <script src="{{ asset('js/page/harlindung/list.js?q=' . Str::random(5)) }}"></script>
@endpush

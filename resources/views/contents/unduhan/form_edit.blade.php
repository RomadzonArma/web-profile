 ...
 <div id="modal-update-unduhan" class="modal fade" tabindex="-1" role="dialog"
 aria-labelledby="modal-update-unduhanLabel" aria-hidden="true">
 <form method="POST" autocomplete="off" enctype="multipart/form-data" action="{{ route('manajemen_unduhan.update') }}" id="form-simpan-edit">
    @csrf
     ...
     <div class="modal-content">
         ...
         <div class="modal-body">
             <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="judul_edit" name="judul" value="{{$data->judul ?? ''}}">
             </div>

...
$(() => {
    ...
    $("#table-data").on("change", ".switch-active", function () {
        ...
        $.post(BASE_URL + "dokumentasi-layanan/switch", {
            id,
            value,
            _method: "PATCH",
        })
    ...
    $("#table-data").on("click", ".btn-delete", function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post(BASE_URL + "dokumentasi-layanan/delete", {
                    id,
                    _method: "DELETE",
                })
                    .done((res) => {
    ...
    $("#form-update-galeri").on("submit", function (e) {
        ...
        $.ajax({
            ...
            success: (res) => {
                ...
                window.location.href = BASE_URL + "dokumentasi-layanan";
            },
            ...
            success: function (response) {
                ...
                response.images.forEach(function (image) {
                    $("#gambar-preview").append(
                        '<img src="' + asset_url + 'file-dokumentasi-layanan/gambar/' + image + '" alt="oto" style="width: 200px;">'
                    );
                });
    ...
    table = $("#table-data").DataTable({
        ...
        processing: true,
        ajax: {
            url: BASE_URL + "dokumentasi-layanan/data",
            type: "get",
            dataType: "json",
        },
        order: [[8, "desc"]],

...
$(() => {
    ...
    $('body').on('click', '.btn-tambah', function (e) {
        ...
        $('#tambah-list-ziwbk').modal('show');

    })

    $('#tambah-list-ziwbk').on('shown.bs.modal', function (e) {
            ...
            success: function (response) {
                ...
                if (response.status == true) {
                    Swal.fire({
                        ...
                        window.location.href = BASE_URL + 'zi_wbk';
                    });
                } else {
...
$('body').on('click', '.btn-update', function (e) {
    ...
    $.ajax({
        url: BASE_URL + 'zi_wbk/edit/' + id,
        type: 'GET',
        success: function (response) {
            $('#edit-list-ziwbk').modal('show');

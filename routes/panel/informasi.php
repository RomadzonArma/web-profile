...
Route::post('/do_update/{id}', 'InformasiPublikController@do_update')->name('informasi-publik.do_update')->middleware('rbac:informasi_publik');
Route::delete('/delete', 'InformasiPublikController@delete')->name('informasi-publik.delete')->middleware('rbac:informasi_publik');
Route::patch('/switch', 'InformasiPublikController@switchStatus')->name('informasi-publik.switch')->middleware('rbac:informasi_publik,3');

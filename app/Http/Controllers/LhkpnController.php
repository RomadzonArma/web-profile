...
class LhkpnController extends Controller
{
    ...
    {
        // dd(Lhkpn::with('dokumen')->get());
        return view('contents.lhkpn.index', [
            'title' => 'List LHKPN'
        ]);
    }
    ...
    {
        $list = Lhkpn::with('dokumen')->select(DB::raw('*'));
    ...
    public function form(Request $request)
    {
        ...
        return view('contents.lhkpn.form', compact('data'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validasi->fails()) {
            ...
            if ($request->hasFile('gambar')) {
                ...
                $path = public_path() . '/storage/uploads/lhkpn';
                ...
                $gambarName = 'storage/uploads/lhkpn/' . $gambar;
            }
            ...
            if ($request->hasFile('dokumen')) {
                ...
                if (!empty($insert_batch)) {
                    LhkpnHasDokumen::insert($insert_batch);
                }
            }
    ...
    {
        $id = decrypt($request->id);
        $data = Lhkpn::with(['dokumen' => function ($q) {
            $q->orderBy('id', 'desc');
        }])->find($id);
        $data->encrypted_id = encrypt($data->id);
        ...
        return view('contents.lhkpn.lihat_dokumen', compact('data'));
    }
    ...
    function hapus_dokumen(Request $request)
    {
        ...
        $count = LhkpnHasDokumen::where('id_ref', $id_ref)->get()->count();
